        ...
        <div id="smooth-content">
                                ...
                                <div class="tw-mt-8 d-flex flex-column tw-gap-12">
                                    <div class="">
                                        ...
                                        <p class="text-neutral-600">Lorem ipsum dolor sit amet, consectetur adipisicing
                                            elit. Placeat qui ducimus illum modi? perspiciatis accusamus soluta
                                            perferendis,
                                    ...
                                    <div class="">
                                        <h5 class="tw-mb-3 splitTextStyleOne">Sed ut perspiciatis unde omnis iste natus
                                            et
                                        </h5>
                                        <p class="text-neutral-600">Need something changed or is there something not
                                            quite
                                            working the way you envisaged? Is your van a little old and tired and need
                                            refreshing? Lorem Ipsum is simply dummy text of the printing and typesetting
                                            industry. Lorem Ipsum has been the industry's standard dummy text ever since
                                        ...
                                        <div class="row gy-4">
                                            <div class="col-sm-6">
                                                <div class="tw-mt-15 d-flex flex-column tw-gap-5">
                                                    <div class="d-flex align-items-center tw-gap-4">
                                                        ...
                                                        <p class="text-neutral-500">Lorem ipsum dolor consectetur the
                                                            nunc semper
                                                    ...
                                                    <div class="d-flex align-items-center tw-gap-4">
                                                        ...
                                                        <p class="text-neutral-500">Dolor consectetur the nunc pulvinar
                                                            vulputate
                                                            neque.</p>
                                                    </div>
                                                    <div class="d-flex align-items-center tw-gap-4">
                                                        ...
                                                        <p class="text-neutral-500">Consectetur the nunc semper pulvinar
                                                            vulputate
                                                            neque.</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="h-100 hover-animation-white">
                                                    <img src="assets/images/thumbs/service-details-img3.png"
                                                        alt="Thumbnail"
                                                        class="tw-rounded-xl w-100 h-100 object-fit-cover">
                                                </div>
                                            </div>
            ...
            <section class="contact pb-120">
                <div class="container">
                    <div class="row gy-4">
                        <!-- Section heading start -->
                        <div class="max-w-780-px text-center mx-auto tw-mb-10" data-aos="fade-up"
